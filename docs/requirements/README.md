...
- **Total Formal Capabilities**: `6`
- **Governing Architectural Decisions (ADRs)**: `1`
- **Active Invariant Guardrails**: `4`
...
| **[GroundTruth Conceptual Catalog](components/conceptual.md)** | `component://groundtruth/conceptual` | Enterprise business glossary, conceptual ontology, business definitions, and synonym taxonomy. | `2` capabilities |
