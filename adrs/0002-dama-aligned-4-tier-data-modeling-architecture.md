# ADR 0002: DAMA-Aligned 4-Tier Data Modeling Architecture

* **Status**: ACCEPTED
* **Date**: 2026-09-02
* **Deciders**: Larry Dawson, GroundTruth Core Team
* **Consulted**: Tripartite Semantic Federation Architects
* **Governing Document**: [ADR 0001: Require MOF Conformance](./0001-require-mof-conformance-for-the-governing-model-definition.md)
